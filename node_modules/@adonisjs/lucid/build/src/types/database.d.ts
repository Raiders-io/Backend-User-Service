...
import { type FromTable, type RawQueryBindings, type RawBuilderContract, type RawQueryBuilderContract, type ReferenceBuilderContract, type InsertQueryBuilderContract, type DatabaseQueryBuilderContract } from './querybuilder.js';
...
export interface DialectContract {
    ...
    getAllTablesWithSchema(schemas?: string[]): Promise<{
        name: string;
        schema?: string;
    }[]>;
...
export type SharedConfigNode = {
    ...
    schemaGeneration?: Partial<Pick<OrmSchemaGeneratorConfig, 'enabled' | 'outputPath' | 'rulesPaths' | 'excludeTables'>>;
    wipe?: {
        ignoreTables?: string[];
    };
    pool?: {
