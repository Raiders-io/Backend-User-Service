...
export class Connection extends EventEmitter {
    ...
    setupWriteConnection() {
        this.client = knex(Object.assign({ log: new ConnectionLogger(this.name, this.logger) }, this.getWriteConfig(), {
            debug: false,
        }));
        // @ts-ignore
    ...
    setupReadConnection() {
        ...
        this.readClient = knex(Object.assign({ log: new ConnectionLogger(this.name, this.logger) }, this.getReadConfig(), {
            debug: false,
        }));
        // @ts-ignore
