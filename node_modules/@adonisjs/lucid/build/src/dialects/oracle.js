...
export class OracleDialect {
    ...
    async getAllTablesWithSchema() {
        throw new Error('"getAllTablesWithSchema" method is not implemented for oracledb. Create a PR to add the feature');
    }
    /**
    ...
    async truncateAllTables() {
        throw new Error('"truncateAllTables" method is not implemented for oracledb. Create a PR to add the feature');
    }
    /**
     * Not implemented yet
     */
    ...
    async getPrimaryKeys(_tableName) {
        throw new Error('"getPrimaryKeys" method is not implemented for oracledb. Create a PR to add the feature');
    }
    getAdvisoryLock() {
