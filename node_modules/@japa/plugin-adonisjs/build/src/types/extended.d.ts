...
import type { RoutesList, URLOptions, LookupList, GetRoutesForMethod, RouteBuilderArguments } from '@adonisjs/core/types/http';
...
declare module '@japa/runner/core' {
    ...
    interface TestContext {
         ...
         * ```
         */
        swap<Binding extends AbstractConstructor<any>>(binding: Binding, fake: InstanceType<Binding> | BindingResolver<any, InstanceType<Binding>>): InstanceType<Binding>;
        /**
         ...
         * ```
         */
        route<Identifier extends keyof GetRoutesForMethod<RoutesList, 'GET'> & string>(...args: RoutesList extends LookupList ? RouteBuilderArguments<Identifier, RoutesList['GET'][Identifier], URLOptions> : []): string;
        /**
