...
export type JsonSchemaModifier<Options extends any> = (schema: JSONSchema7, options: Options) => void;
/**
 ...
 * }
 */
export type ValidationOptions<MetaData extends Record<string, any> | undefined> = BaseValidationTypes & ValidationOptionsMetaProp<MetaData>;
...
export interface ValidatorBuilder<MetaData extends Record<string, any>> {
    ...
    create<Properties extends Record<string, SchemaTypes>, Schema extends VineObject<Properties, UndefinedOptional<{
    ...
    }>>>(properties: Properties): VineValidator<Schema, MetaData>;
