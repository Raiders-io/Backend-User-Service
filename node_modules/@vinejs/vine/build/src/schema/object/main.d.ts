...
import type { Validation, SchemaTypes, FieldOptions, ParserOptions, PropertiesToOptional, UndefinedOptional, WithJSONSchema } from '../../types.js';
 ...
 * })
 */
export declare class VineObject<Properties extends Record<string, SchemaTypes>, Input, Output, CamelCaseOutput> extends BaseType<Input, Output, CamelCaseOutput> implements WithJSONSchema {
    #private;
    /**
     * Unique name identifier for union type resolution
     */
     ...
     */
    partial<Keys extends keyof Properties = keyof Properties, T extends Record<string, SchemaTypes> = Omit<Properties, Keys> & PropertiesToOptional<Pick<Properties, Keys>>>(keys?: Keys[] | readonly Keys[]): VineObject<Prettify<T>, UndefinedOptional<{
