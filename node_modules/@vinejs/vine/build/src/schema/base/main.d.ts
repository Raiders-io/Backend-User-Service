...
export declare class MetaModifier<Schema extends ConstructableSchema<any, any, any>> implements ConstructableSchema<Schema[typeof ITYPE], Schema[typeof OTYPE], Schema[typeof COTYPE]> {
    #private;
