 ...
 */
export declare class MetaModifier<Schema extends ConstructableLiteralSchema<any, any, any>> implements ConstructableLiteralSchema<Schema[typeof ITYPE], Schema[typeof OTYPE], Schema[typeof COTYPE]> {
    #private;
    get isOptional(): boolean | undefined;
    get allowNull(): boolean | undefined;
    /**
     * Define the input type of the schema
     */
