...
import type { DateFieldOptions, FieldContext, PropertiesToOptional, SchemaTypes } from '../types.js';
...
export declare const helpers: {
    ...
    isVAT: typeof import("validator").isVAT;
     ...
     */
    optional<Props extends Record<string, SchemaTypes>>(props: Props): Prettify<PropertiesToOptional<Props>>;
};
